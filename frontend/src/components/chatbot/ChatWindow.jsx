...
export default function ChatWindow({ messages, isStreaming }) {
  ...
  return (
    <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-1 bg-gradient-to-b from-cream-50/50 to-white">
      {messages.length === 0 && !isStreaming && (
        <div className="flex flex-col items-center justify-center h-full text-center px-6">
          <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-sage-100 to-cream-200 flex items-center justify-center mb-5 shadow-inner">
          ...
          <h3 className="font-display text-xl font-semibold text-espresso-700 mb-2">Your Health Assistant</h3>
