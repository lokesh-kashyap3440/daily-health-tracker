    ...
    >
      ...
      <div className={`w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0 mt-0.5 shadow-sm ${
        isUser
          ...
          : 'bg-gradient-to-br from-cream-200 to-cream-300 text-sage-700 border border-cream-300'
      }`}>
      ...
      <div className={`max-w-[80%] px-4 py-3 rounded-2xl text-sm leading-relaxed ${
        isUser
          ...
          : 'bg-white text-espresso-700 border border-cream-200 shadow-sm chat-tail-bot'
      }`}>
        {isStreaming && !content ? (
