...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-cream-100 via-cream-50 to-sage-50 px-4 relative overflow-hidden dark:from-dark-950 dark:via-dark-900 dark:to-dark-950">
      ...
      <div className="absolute bottom-20 left-10 text-sage-200/20 animate-float pointer-events-none dark:text-sage-800/20" style={{ animationDelay: '2s' }}>
        <Leaf size={36} />
      </div>
      ...
      <div className="w-full max-w-md relative z-10 animate-slide-up">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="font-display text-4xl font-semibold text-espresso-800 tracking-tight dark:text-cream-100">
            Join Health<span className="text-sage-600 dark:text-sage-400">Tracker</span>
          </h1>
          <p className="text-espresso-400 text-sm mt-2 dark:text-dark-400">Start your wellness journey today</p>
        </div>
